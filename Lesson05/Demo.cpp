...
void Demo::Update(double deltaTime) {
	// cc rotation
	angle += (float) ((deltaTime * 31.5f) / 1000);
}
...
void Demo::Render() {
	...
	// Body
	DrawColoredCube(0, 0, 2, 0, 4, 3, 3);

	// Belakang
	DrawColoredCube(0, 4, 2, 0, 5, 1.5, 1.5);
	
	// Propeller Belakang
	DrawColoredCube(1, 6, 1.9, 2, 3, 0.5, 0.5);

	// Atas
	DrawColoredCube(2, 0, 4, 0, 0.5, 2, 0.5);
	
	// Propeller Atas
	DrawColoredCube(2, 0, 5.2, 0, 10, 0.5, 0.5);
...
void Demo::DrawColoredCube(int rotate, float positionX, float positionY, float positionZ, float scaleX, float scaleY, float scaleZ)
{
